  ...
  return (
    <PrincipalStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <PrincipalStack.Screen
        name="PrincipalClassPulse"
        component={PrincipalClassPulseScreen}
        options={{ headerShown: true, title: 'ClassPulse', ...SHARED_TAB_OPTS }}
      />
      <PrincipalStack.Screen
        name="Profile"
        component={ProfileScreen}
        options={{ headerShown: true, title: 'Profile', ...SHARED_TAB_OPTS }}
      />
  ...
  return (
    <HODStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <HODStack.Screen
        ...
        options={{ headerShown: true, title: 'Leave Requests', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="TeacherDetail"
        component={TeacherDetailScreen}
        options={{ headerShown: true, title: 'Teacher Detail', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="StudentDetail"
        component={StudentDetailScreen}
        options={{ headerShown: true, title: 'Student Detail', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="SemesterProgress"
        component={SemesterProgressScreen}
        options={{ headerShown: true, title: 'Semester Progress', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="SectionAnalytics"
        component={SectionAnalyticsScreen}
        options={{ headerShown: true, title: 'Section Analytics', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="DeptOverview"
        component={DeptOverviewScreen}
        options={{ headerShown: true, title: 'Department Overview', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="Sections"
        component={SectionsScreen}
        options={{ headerShown: true, title: 'Sections', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="Subjects"
        component={SubjectsScreen}
        options={{ headerShown: true, title: 'Subjects', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="HODTimetable"
        component={HODTimetableScreen}
        options={{ headerShown: true, title: 'Timetable', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="ExcelImport"
        component={ExcelImportScreen}
        options={{ headerShown: true, title: 'Import Students', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="TutorManagement"
        component={TutorManagementScreen}
        options={{ headerShown: true, title: 'Tutor Management', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="HODReportsHome"
        component={HODReportsHomeScreen}
        options={{ headerShown: true, title: 'Reports', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="LiveAnalytics"
        component={LiveAnalyticsScreen}
        options={{ headerShown: true, title: 'Live Sessions', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="TeacherPerformance"
        component={TeacherPerformanceScreen}
        options={{ headerShown: true, title: 'Teacher Performance', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="HODDisputes"
        component={HODDisputesScreen}
        options={{ headerShown: true, title: 'Disputes', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="HODClassPulse"
        component={HODClassPulseScreen}
        options={{ headerShown: true, title: 'ClassPulse', ...SHARED_TAB_OPTS }}
      />
      <HODStack.Screen
        name="Profile"
...
function TeacherTabNavigator({ navigation }) {
  ...
  return (
    <TeacherTab.Navigator screenOptions={{ ...SHARED_TAB_OPTS, headerRight }}>
      ...
      <TeacherTab.Screen
        name="ClassPulse"
        component={TeacherClassPulseHomeScreen}
...
function TeacherNavigator() {
  return (
    <TeacherStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <TeacherStack.Screen
        name="CapsuleAnalytics"
        component={CapsuleAnalyticsMobileScreen}
        options={{ headerShown: true, ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="AnswerDoubt"
        component={AnswerDoubtMobileScreen}
        options={{ headerShown: true, ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="AttendanceManage"
        component={AttendanceManageScreen}
        options={{ headerShown: true, title: 'Manage Attendance', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="LeaveManagement"
        component={LeaveManagementScreen}
      ...
      <TeacherStack.Screen
        ...
        options={{ headerShown: true, title: 'Subject Analytics', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="Disputes"
        component={TeacherDisputesScreen}
        options={{ headerShown: true, title: 'Pending Disputes', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="LiveSessionDash"
        component={LiveSessionDashboardScreen}
        options={{ headerShown: true, title: 'Live Session', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="LiveSessionDashboard"
        component={LiveSessionDashboardScreen}
        options={{ headerShown: true, title: 'Live Session', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="TWMDashboard"
        component={TWMDashboardScreen}
        options={{ headerShown: true, title: 'TWM Sessions', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="TutorDashboard"
        component={TutorDashboardScreen}
        options={{ headerShown: true, title: 'My Wards', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="PreClassBrief"
        component={PreClassBriefScreen}
        options={{ headerShown: true, title: 'Pre-Class Brief', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="SessionHealthReport"
        component={SessionHealthReportScreen}
        options={{ headerShown: true, title: 'Health Report', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="MyLiveSessions"
        component={MyLiveSessionsScreen}
        options={{ headerShown: true, title: 'My Live Sessions', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="AttendanceHistory"
        component={TeacherAttendanceHistoryScreen}
        options={{ headerShown: true, title: 'Attendance History', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="CareerRoadmap"
        component={CareerRoadmapScreen}
        options={{ headerShown: true, title: 'Career Roadmap', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="SuggestionBox"
        component={SuggestionBoxScreen}
        options={{ headerShown: true, title: 'Suggestion Box', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="Feed"
        component={FeedScreen}
        options={{ headerShown: true, title: 'Feed', ...SHARED_TAB_OPTS }}
      />
      <TeacherStack.Screen
        name="Profile"
        component={ProfileScreen}
...
function StudentTabNavigator({ navigation }) {
  ...
  return (
    <StudentTab.Navigator screenOptions={{ ...SHARED_TAB_OPTS, headerRight }}>
      ...
      <StudentTab.Screen
        name="ClassPulse"
        component={ClassPulseHomeScreen}
        options={{ title: 'ClassPulse', tabBarIcon: icon('library-outline') }}
      />
      <StudentTab.Screen
        name="Attendance"
...
function StudentNavigator() {
  return (
    <StudentStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <StudentStack.Screen
        name="ClassPulseSubject"
        component={ClassPulseSubjectScreen}
        options={{ headerShown: true, ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="CapsuleDetail"
        component={CapsuleMobileDetailScreen}
        options={{ headerShown: true, ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="ClassWall"
        component={ClassWallMobileScreen}
        options={{ headerShown: true, ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="LeaveRequest"
        component={LeaveRequestScreen}
        options={{ headerShown: true, title: 'My Leave Requests', ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="Notifications"
        component={NotificationsScreen}
        options={{ headerShown: true, title: 'Notifications', ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="Dispute"
        component={DisputeScreen}
        options={{ headerShown: true, title: 'Attendance Dispute', ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="SuggestionBox"
        component={SuggestionBoxScreen}
      ...
      />
      <StudentStack.Screen
        name="AttendanceForecast"
        component={AttendanceForecastScreen}
        options={{ headerShown: true, title: 'Attendance Forecast', ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="MyTutor"
        component={MyTutorScreen}
        options={{ headerShown: true, title: 'My Tutor', ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="KnowledgeGraph"
        component={StudentKnowledgeGraphScreen}
        options={{ headerShown: true, title: 'Knowledge Graph', ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="MySessions"
        component={MySessionsScreen}
        options={{ headerShown: true, title: 'My Sessions', ...SHARED_TAB_OPTS }}
      />
      <StudentStack.Screen
        name="CareerRoadmap"
        component={CareerRoadmapScreen}
