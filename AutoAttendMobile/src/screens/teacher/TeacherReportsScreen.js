        ...
        renderItem={({ item: c }) => (
          <View style={styles.card}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.meta}>{c.code} · Sem {c.semester ?? '—'}</Text>
            </View>
            <TouchableOpacity
              style={styles.dlBtn}
...
const styles = StyleSheet.create({
  ...
  dlBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: PRIMARY, alignItems: 'center', justifyContent: 'center' },
