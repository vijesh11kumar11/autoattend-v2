...
export default function HODReportsScreen() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.warn('[HODReports] count error:', err?.message);
    }
  }, []);
  ...
  const CARDS = [
    {
      ...
      color: '#ef4444',
      onPress: dlDefaulters,
    },
    {
      key: 'monthly',
      icon: 'calendar-outline',
      title: 'Monthly Excel',
      sub: 'Per-subject monthly',
      color: '#22c55e',
    ...
    },
    {
      ...
      title: 'Class Session PDF',
      sub: 'Single session report',
      color: '#3b82f6',
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['left', 'right']}>
      ...
      >
        ...
        <View style={[styles.summary, defaulterCount > 0 && styles.danger]}>
          <Ionicons
            ...
            size={28}
            color={defaulterCount > 0 ? '#ef4444' : '#22c55e'}
          />
      ...
      <Modal
        ...
        transparent
        animationType="fade"
        onRequestClose={() => setShowMonthly(false)}
      >
          ...
          <View style={styles.modalCard}>
            ...
            <View style={{ flexDirection: 'row', gap: 8 }}>
              <TextInput
                ...
                onChangeText={(v) => setMonthYear((p) => ({ ...p, year: v }))}
              />
              <TextInput
                style={[styles.input, { flex: 1 }]}
                ...
                onChangeText={(v) => setMonthYear((p) => ({ ...p, month: v }))}
              />
            </View>
            <View style={styles.modalRow}>
              <TouchableOpacity style={styles.cancelBtn} onPress={() => setShowMonthly(false)}>
                <Text style={styles.cancelTxt}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.okBtn} onPress={dlMonthly}>
                <Text style={styles.okTxt}>Download</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
      ...
      <Modal
        ...
        transparent
        animationType="fade"
        onRequestClose={() => setShowClass(false)}
      >
        <View style={styles.modalBg}>
          <View style={styles.modalCard}>
            ...
            />
            <View style={styles.modalRow}>
              <TouchableOpacity style={styles.cancelBtn} onPress={() => setShowClass(false)}>
                <Text style={styles.cancelTxt}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.okBtn} onPress={dlClass}>
                <Text style={styles.okTxt}>Download</Text>
              </TouchableOpacity>
            </View>
          </View>
