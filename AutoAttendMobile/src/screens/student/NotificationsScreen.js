      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            ...
            {unreadCount > 0 && (
              <TouchableOpacity style={styles.markAllBtn} onPress={markAllRead} activeOpacity={0.85}>
          ...
          return (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.message} numberOfLines={4}>{a.message}</Text>
                {a.channel && (
...
const styles = StyleSheet.create({
  ...
  markAllBtn:  { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: PRIMARY },
