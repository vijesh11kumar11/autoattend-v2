  ...
  return (
    <SafeAreaView style={styles.safe} edges={['left', 'right']}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {REPORTS.map(r => (
          <TouchableOpacity key={r.id} style={styles.card} onPress={() => handleDownload(r)} disabled={downloading === r.id}>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoTxt}>
            For per-department or per-class reports, visit the web dashboard where advanced filters are available.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 14, padding: 16, marginBottom: 12, flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  infoCard: { backgroundColor: '#eff6ff', borderRadius: 12, padding: 14, flexDirection: 'row', alignItems: 'flex-start', gap: 8, marginTop: 12 },
