    ...
    <div className="space-y-6">
      ...
      <div className="card p-5">
        ...
        <p className="text-sm text-slate-400 mt-1">
          All disputes across your department. Escalate unresolved disputes that teachers haven't
          acted on.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="card p-4 text-center">
          <p className="text-2xl font-bold text-emerald-600">
            {resolved.filter((d) => d.status === 'resolved').length}
          </p>
          ...
          <div className="card w-full max-w-md p-6 space-y-4 m-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="HOD escalation note…"
                rows={3}
                maxLength={500}
