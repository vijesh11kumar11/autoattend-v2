/**
 * TRACELN v2.0 — Career Roadmap Generator
...
const ROLE_CFG = {
  student: {
    banner: {
      ...
      sub: 'Plan your path from student to tech professional',
    ...
    levels: [
      { key: 'beginner', icon: '🌱', label: 'Beginner', desc: 'Just starting my tech journey' },
      {
        ...
        icon: '🔥',
        label: 'Intermediate',
        desc: 'Built some projects already',
      },
      { key: 'advanced', icon: '🚀', label: 'Advanced', desc: 'Ready for industry-level work' },
    ],
    loadingSteps: [
      'Analysing your subjects...',
      'Checking your attendance data...',
  ...
  teacher: {
    banner: {
      ...
      sub: 'Advance your academic and professional career',
    ...
    loadingSteps: [
      'Reviewing your teaching profile...',
      'Analysing your class performance...',
      'Consulting Gemini AI...',
  ...
  hod: {
    banner: {
      ...
      sub: 'Chart your path to academic leadership excellence',
    ...
    goals: [
      ...
      'Autonomous College Principal',
      'NAAC Coordinator',
      'Education Ministry Advisor',
      'International Collaboration Lead',
    ...
    levels: [
      { key: 'beginner', icon: '🌱', label: 'Beginner', desc: 'Leading a department' },
      {
        ...
        icon: '🔥',
        label: 'Intermediate',
        desc: 'Experienced department head',
      },
      {
        key: 'advanced',
        icon: '🚀',
        label: 'Advanced',
        desc: 'Ready for institutional leadership',
      },
    ],
    loadingSteps: [
      'Reviewing your department metrics...',
  ...
  principal: {
    banner: {
      ...
      sub: 'Shape the future of education leadership',
      bg: 'from-[#4a0000] to-[#880e4f]',
    },
    goals: [
      'University Vice Chancellor',
      'Education Board Member',
      'NAAC Peer Team Member',
      'National Education Policy Contributor',
      'International University Collaboration Expert',
      'Education Research Publisher',
    ],
    skillHints: [
    ...
    levels: [
      { key: 'beginner', icon: '🌱', label: 'Beginner', desc: 'Running an institution' },
      {
        ...
        icon: '🔥',
        label: 'Intermediate',
        desc: 'Experienced institutional leader',
      },
      { key: 'advanced', icon: '🚀', label: 'Advanced', desc: 'National-level influence' },
    ],
    loadingSteps: [
      'Reviewing institutional data...',
      'Analysing leadership scope...',
      'Consulting Gemini AI...',
      'Building your executive roadmap...',
    ],
    phaseKey: 'initiatives',
    phaseLabel: 'Initiatives',
  },
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {cfg.goals.map((g) => (
                ...
                >
                  ...
                  <span
                    className={`text-sm font-medium ${goal === g ? 'text-indigo-700' : 'text-slate-700'}`}
                  >
                    {g}
                  </span>
                </button>
            ...
            {skills.length === 0 && (
              <div className="flex flex-wrap gap-1.5">
                ...
                {cfg.skillHints.slice(0, 6).map((h) => (
                  <button
                    key={h}
                    onClick={() => !skills.includes(h) && setSkills((p) => [...p, h])}
            ...
            <div className="grid grid-cols-3 gap-3">
              {cfg.levels.map((l) => (
                ...
                >
                  ...
                  <p
                    className={`text-sm font-semibold ${level === l.key ? 'text-indigo-700' : 'text-slate-700'}`}
                  >
                    {l.label}
                  </p>
                      ...
                      {(phase[cfg.phaseKey] || phase.projects || phase.initiatives)?.length > 0 && (
                        <div className="mb-3">
                          ...
                          <div className="space-y-1.5">
                            {(phase[cfg.phaseKey] || phase.projects || phase.initiatives).map(
                              (p, j) => (
                                <div
                                  key={j}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-5">
                ...
                <span
                  ...
                  ${
                    data.market_demand.demand_level === 'High'
                      ? 'bg-emerald-100 text-emerald-700'
                      : data.market_demand.demand_level === 'Medium'
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {data.role_specific_advantages.map((a, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-3 p-3 bg-emerald-50 border border-emerald-200 rounded-xl"
                      >
